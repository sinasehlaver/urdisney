...
int main(int argc, char** argv)
{
  ...
  const Eigen::Affine3d& end_effector_state = kinematic_state->getGlobalLinkTransform("right_inner_knuckle");

  /* Print end-effector pose. Remember that this is in the model frame */

  std::vector<std::vector<double>> state{{end_effector_state.translation().x(),end_effector_state.translation().y(),end_effector_state.translation().z()/2},{0,0,0}};
  exportFrames(state, "mid.txt");
